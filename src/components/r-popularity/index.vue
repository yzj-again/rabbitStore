  ...
  <div class="r-popularity-components">
    <div class="r-popularity-top">
      ...
      <div class="r-popularity-more">
        <a href="javascript:;" @click="changeBrand('prev')" :class="{noclass:currentIndex<1}">
          <i class="iconfont icon-previous-icon"></i>
        </a>
        <a href="javascript:;" @click="changeBrand('next')" :class="{noclass:currentIndex>0}">
