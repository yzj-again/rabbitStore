    ...
    <div class="container">
      ...
      <div class="index-cate-swiper">
        ...
        <div class="swiper-area">
          <rswiper :swiperData="indexState.bannerData" :autoPlay="true"></rswiper>
        </div>
      </div>
    </div>
    <!--首页商品内容区域-->
      ...
      <div class="container">
        <div class="index-innerproduct" >
          ...
          <div class="product-parttwo" ref="brandproduct">
            <rpopularity title="热门品牌" desc="国际经典 品质保证" :brandData="indexState.brandData" v-if="indexState.brandData.length>0"></rpopularity>
...
export default {
  ...
  setup () {
    ...
    return { indexState, showbox, hotproduct, brandproduct, mainproduct, newproduct, showRenpick }
  },
  components: {
    rcategory,
    rswiper,
